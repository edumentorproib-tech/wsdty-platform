      ...
      <div className="w-full max-w-md">
        ...
        <div className="card p-8">
          ...
          <button
            ...
            disabled={loading}
            className="w-full border border-border text-white font-medium py-2.5 px-4 rounded-md hover:bg-surface-2 transition-colors disabled:opacity-50 flex items-center justify-center gap-3"
          >
